...
public class Porta {
    ...
    public static void main(String[] args) {
        ...
        lengthenedKeyword = generatePortaKeyword(keyword, input);
    ...
    public static String generatePortaKeyword(String keyword, String input) {
    ...
    public static int[] addNumericStrings(int[] numericInput, int[] numericKeyword) {
        ...
        int[] returnAddedNumeric = new int[numericInput.length];
                ...
                for (int i = 0; i < numericInput.length; i++) {
                    ...
                    if(numericInput[i]<13){
                        
                returnAddedNumeric[i] = (numericInput[i] + (numericKeyword[i])/2) % 13 + 13;
