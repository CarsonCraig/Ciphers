...
public class VariantBeaufort {
    ...
    public static void main(String[] args) {
        ...
        lengthenedKeyword = generateVariantBeaufortKeyword(keyword, input);
    ...
    public static String generateVariantBeaufortKeyword(String keyword, String input) {
